...
void NNArea2DVisibilitySensor::_bind_methods() {
	ADD_GROUP("Configuration", "");

	ClassDB::bind_method(D_METHOD("set_use_owner_global_position", "use_owner_global_position"), &NNArea2DVisibilitySensor::set_use_owner_global_position);
	ClassDB::bind_method(D_METHOD("get_use_owner_global_position"), &NNArea2DVisibilitySensor::get_use_owner_global_position);
	...
	ClassDB::bind_method(D_METHOD("set_offset_vector", "offset_vector"), &NNArea2DVisibilitySensor::set_offset_vector2);
	ClassDB::bind_method(D_METHOD("get_offset_vector"), &NNArea2DVisibilitySensor::get_offset_vector2);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR2, "offset_vector", PROPERTY_HINT_NONE), "set_offset_vector", "get_offset_vector");

	ClassDB::bind_method(D_METHOD("set_visibility_volume", "visibility_volume"), &NNArea2DVisibilitySensor::set_visibility_volume);
	ClassDB::bind_method(D_METHOD("get_visibility_volume"), &NNArea2DVisibilitySensor::get_visibility_volume);
	...
	ClassDB::bind_method(D_METHOD("set_max_expected_entities_found", "max_expected_entities_found"), &NNArea2DVisibilitySensor::set_max_expected_entities_found);
	ClassDB::bind_method(D_METHOD("get_max_expected_entities_found"), &NNArea2DVisibilitySensor::get_max_expected_entities_found);
	...
	ClassDB::bind_method(D_METHOD("set_do_occlusion_test", "do_occlusion_test"), &NNArea2DVisibilitySensor::set_do_occlusion_test);
	ClassDB::bind_method(D_METHOD("get_do_occlusion_test"), &NNArea2DVisibilitySensor::get_do_occlusion_test);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "do_occlusion_test", PROPERTY_HINT_NONE), "set_do_occlusion_test", "get_do_occlusion_test");

	ClassDB::bind_method(D_METHOD("set_collision_mask", "collision_mask"), &NNArea2DVisibilitySensor::set_collision_mask);
	ClassDB::bind_method(D_METHOD("get_collision_mask"), &NNArea2DVisibilitySensor::get_collision_mask);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "collision_mask", PROPERTY_HINT_LAYERS_3D_PHYSICS), "set_collision_mask", "get_collision_mask");

	ClassDB::bind_method(D_METHOD("set_occlusion_test_exclusion_list", "occlusion_test_exclusion_list"), &NNArea2DVisibilitySensor::set_occlusion_test_exclusion_list);
	ClassDB::bind_method(D_METHOD("get_occlusion_test_exclusion_list"), &NNArea2DVisibilitySensor::get_occlusion_test_exclusion_list);
	...
	//ClassDB::bind_method(D_METHOD("set_entity_mask", "entity_mask"), &NNArea2DVisibilitySensor::set_entity_mask);
	//ClassDB::bind_method(D_METHOD("get_entity_mask"), &NNArea2DVisibilitySensor::get_entity_mask);
	//ADD_PROPERTY(PropertyInfo(Variant::INT, "entity_mask", PROPERTY_HINT_LAYERS_3D_PHYSICS), "set_entity_mask","get_entity_mask");

	ClassDB::bind_method(D_METHOD("on_area_entered", "area"), &NNArea2DVisibilitySensor::on_area_entered);
	ClassDB::bind_method(D_METHOD("on_area_exited", "area"), &NNArea2DVisibilitySensor::on_area_exited);
	ClassDB::bind_method(D_METHOD("on_body_entered", "body"), &NNArea2DVisibilitySensor::on_body_entered);
	ClassDB::bind_method(D_METHOD("on_body_exited", "body"), &NNArea2DVisibilitySensor::on_body_exited);

	ADD_GROUP("Debugging", "");

	ClassDB::bind_method(D_METHOD("set_from_vector", "from_vector"), &NNArea2DVisibilitySensor::set_from_vector2);
	ClassDB::bind_method(D_METHOD("get_from_vector"), &NNArea2DVisibilitySensor::get_from_vector2);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR2, "from_vector", PROPERTY_HINT_NONE), "set_from_vector", "get_from_vector");

	ClassDB::bind_method(D_METHOD("set_num_entities_found", "num_entities_found"), &NNArea2DVisibilitySensor::set_num_entities_found);
	ClassDB::bind_method(D_METHOD("get_num_entities_found"), &NNArea2DVisibilitySensor::get_num_entities_found);
	...
	ClassDB::bind_method(D_METHOD("set_closest_intersecting_area_index", "closest_intersecting_area_index"), &NNArea2DVisibilitySensor::set_closest_intersecting_area_index);
	ClassDB::bind_method(D_METHOD("get_closest_intersecting_area_index"), &NNArea2DVisibilitySensor::get_closest_intersecting_area_index);
	...
	ClassDB::bind_method(D_METHOD("set_intersecting_areas", "intersecting_areas"), &NNArea2DVisibilitySensor::set_intersecting_areas);
	ClassDB::bind_method(D_METHOD("get_intersecting_areas"), &NNArea2DVisibilitySensor::get_intersecting_areas);
	...
	ClassDB::bind_method(D_METHOD("set_squared_distances_to_intersecting_areas", "squared_distances_to_intersecting_areas"), &NNArea2DVisibilitySensor::set_squared_distances_to_intersecting_areas);
	ClassDB::bind_method(D_METHOD("get_squared_distances_to_intersecting_areas"), &NNArea2DVisibilitySensor::get_squared_distances_to_intersecting_areas);
	...
	ClassDB::bind_method(D_METHOD("set_closest_unoccluded_area_index", "closest_unoccluded_area_index"), &NNArea2DVisibilitySensor::set_closest_unoccluded_area_index);
	ClassDB::bind_method(D_METHOD("get_closest_unoccluded_area_index"), &NNArea2DVisibilitySensor::get_closest_unoccluded_area_index);
	...
	ClassDB::bind_method(D_METHOD("set_unoccluded_areas", "unoccluded_areas"), &NNArea2DVisibilitySensor::set_unoccluded_areas);
	ClassDB::bind_method(D_METHOD("get_unoccluded_areas"), &NNArea2DVisibilitySensor::get_unoccluded_areas);
	...
	ClassDB::bind_method(D_METHOD("set_squared_distances_to_unoccluded_areas", "squared_distances_to_unoccluded_areas"), &NNArea2DVisibilitySensor::set_squared_distances_to_unoccluded_areas);
	ClassDB::bind_method(D_METHOD("get_squared_distances_to_unoccluded_areas"), &NNArea2DVisibilitySensor::get_squared_distances_to_unoccluded_areas);
	...
	ClassDB::bind_method(D_METHOD("set_closest_intersecting_body_index", "closest_intersecting_body_index"), &NNArea2DVisibilitySensor::set_closest_intersecting_body_index);
	ClassDB::bind_method(D_METHOD("get_closest_intersecting_body_index"), &NNArea2DVisibilitySensor::get_closest_intersecting_body_index);
	...
	ClassDB::bind_method(D_METHOD("set_intersecting_bodies", "intersecting_bodies"), &NNArea2DVisibilitySensor::set_intersecting_bodies);
	ClassDB::bind_method(D_METHOD("get_intersecting_bodies"), &NNArea2DVisibilitySensor::get_intersecting_bodies);
	...
	ClassDB::bind_method(D_METHOD("set_squared_distances_to_intersecting_bodies", "squared_distances_to_intersecting_bodies"), &NNArea2DVisibilitySensor::set_squared_distances_to_intersecting_bodies);
	ClassDB::bind_method(D_METHOD("get_squared_distances_to_intersecting_bodies"), &NNArea2DVisibilitySensor::get_squared_distances_to_intersecting_bodies);
	...
	ClassDB::bind_method(D_METHOD("set_closest_unoccluded_body_index", "closest_unoccluded_body_index"), &NNArea2DVisibilitySensor::set_closest_unoccluded_body_index);
	ClassDB::bind_method(D_METHOD("get_closest_unoccluded_body_index"), &NNArea2DVisibilitySensor::get_closest_unoccluded_body_index);
	...
	ClassDB::bind_method(D_METHOD("set_unoccluded_bodies", "unoccluded_bodies"), &NNArea2DVisibilitySensor::set_unoccluded_bodies);
	ClassDB::bind_method(D_METHOD("get_unoccluded_bodies"), &NNArea2DVisibilitySensor::get_unoccluded_bodies);
	...
	ClassDB::bind_method(D_METHOD("set_squared_distances_to_unoccluded_bodies", "squared_distances_to_unoccluded_bodies"), &NNArea2DVisibilitySensor::set_squared_distances_to_unoccluded_bodies);
	ClassDB::bind_method(D_METHOD("get_squared_distances_to_unoccluded_bodies"), &NNArea2DVisibilitySensor::get_squared_distances_to_unoccluded_bodies);
...
NNArea2DVisibilitySensor::NNArea2DVisibilitySensor() {
...
/*void NNArea2DVisibilitySensor::_ready() {
	initialize_sensor();
}
/**

void NNArea2DVisibilitySensor::_notification(int p_what) {
	switch (p_what) {
...
void NNArea2DVisibilitySensor::_update_cache() {
	_cache = ObjectID();
...
void NNArea2DVisibilitySensor::initialize_sensor() {
	...
	ERR_FAIL_COND_MSG(_visibility_volume == nullptr, "NNArea2DVisibilitySensor::initialize_sensor() - Error, the visibility volume is not set.");
...
void NNArea2DVisibilitySensor::uninitialize_sensor() {
	if (Engine::get_singleton()->is_editor_hint())
		return;
	if (_visibility_volume != nullptr) {
...
float NNArea2DVisibilitySensor::evaluate_sensor_value() {
	if (_visibility_volume == nullptr) {
...
void NNArea2DVisibilitySensor::on_area_entered(Area2D *area) {
...
void NNArea2DVisibilitySensor::on_area_exited(Area2D *area) {
...
void NNArea2DVisibilitySensor::on_body_entered(Node2D *body) {
...
void NNArea2DVisibilitySensor::on_body_exited(Node2D *body) {
...
void NNArea2DVisibilitySensor::set_use_owner_global_position(bool use_owner_global_position) {
...
bool NNArea2DVisibilitySensor::get_use_owner_global_position() const {
	return _use_owner_global_position;
}

void NNArea2DVisibilitySensor::set_from_vector2(Vector2 from) {
	_has_sensor_value_changed = _has_sensor_value_changed || (_from_vector != from);
	_from_vector = from;
}

Vector2 NNArea2DVisibilitySensor::get_from_vector2() const {
	return _from_vector;
}

void NNArea2DVisibilitySensor::set_offset_vector2(Vector2 offset) {
	_has_sensor_value_changed = _has_sensor_value_changed || (_offset_vector != offset);
	_offset_vector = offset;
}

Vector2 NNArea2DVisibilitySensor::get_offset_vector2() const {
	return _offset_vector;
}

void NNArea2DVisibilitySensor::set_visibility_volume(Area2D *visibility_volume) {
...
Area2D *NNArea2DVisibilitySensor::get_visibility_volume() const {
	return _visibility_volume;
}

void NNArea2DVisibilitySensor::set_do_occlusion_test(bool do_occlusion_test) {
...
bool NNArea2DVisibilitySensor::get_do_occlusion_test() const {
	return _do_occlusion_test;
}

void NNArea2DVisibilitySensor::set_collision_mask(uint32_t collision_mask) {
	_has_sensor_value_changed = _has_sensor_value_changed || (_collision_mask != collision_mask);
	_collision_mask = collision_mask;
}

uint32_t NNArea2DVisibilitySensor::get_collision_mask() const {
	return _collision_mask;
}

/**
void NNArea2DVisibilitySensor::set_entity_mask( uint32_t entity_mask) {
	_entity_mask = entity_mask;
}

uint32_t NNArea2DVisibilitySensor::get_entity_mask() const {
	return _entity_mask;
}
/**/

void NNArea2DVisibilitySensor::set_max_expected_entities_found(int max_expected_entities_found) {
...
int NNArea2DVisibilitySensor::get_max_expected_entities_found() const {
	return _max_expected_entities_found;
}

void NNArea2DVisibilitySensor::set_occlusion_test_exclusion_list(TypedArray<RID> occlusion_test_exclusion_list) {
...
TypedArray<RID> NNArea2DVisibilitySensor::get_occlusion_test_exclusion_list() const {
	return _occlusion_test_exclusion_list;
}

// Debugging / current values.

void NNArea2DVisibilitySensor::set_num_entities_found(int num_entities_found) {
...
int NNArea2DVisibilitySensor::get_num_entities_found() const {
	return _num_entities_found;
}

void NNArea2DVisibilitySensor::set_closest_intersecting_area_index(int closest_intersecting_area_index) {
...
void NNArea2DVisibilitySensor::set_closest_intersecting_body_index(int closest_intersecting_body_index) {
...
int NNArea2DVisibilitySensor::get_closest_intersecting_area_index() const {
	return _closest_intersecting_area_index;
}

int NNArea2DVisibilitySensor::get_closest_intersecting_body_index() const {
	return _closest_intersecting_body_index;
}

void NNArea2DVisibilitySensor::set_closest_unoccluded_area_index(int closest_unoccluded_area_index) {
...
void NNArea2DVisibilitySensor::set_closest_unoccluded_body_index(int closest_unoccluded_body_index) {
...
int NNArea2DVisibilitySensor::get_closest_unoccluded_area_index() const {
	return _closest_unoccluded_area_index;
}

int NNArea2DVisibilitySensor::get_closest_unoccluded_body_index() const {
	return _closest_unoccluded_body_index;
}

void NNArea2DVisibilitySensor::set_intersecting_areas(TypedArray<Area2D> intersecting_areas) {
...
void NNArea2DVisibilitySensor::set_intersecting_bodies(TypedArray<Node2D> intersecting_bodies) {
...
TypedArray<Area2D> NNArea2DVisibilitySensor::get_intersecting_areas() const {
	return _intersecting_areas;
}

TypedArray<Node2D> NNArea2DVisibilitySensor::get_intersecting_bodies() const {
	return _intersecting_bodies;
}

void NNArea2DVisibilitySensor::set_unoccluded_areas(TypedArray<Area2D> unoccluded_areas) {
	_has_sensor_value_changed = _has_sensor_value_changed || (_unoccluded_areas != unoccluded_areas);
	_unoccluded_areas = unoccluded_areas;
}

void NNArea2DVisibilitySensor::set_unoccluded_bodies(TypedArray<Node2D> unoccluded_bodies) {
...
TypedArray<Area2D> NNArea2DVisibilitySensor::get_unoccluded_areas() const {
	return _unoccluded_areas;
}

TypedArray<Node2D> NNArea2DVisibilitySensor::get_unoccluded_bodies() const {
	return _unoccluded_bodies;
}

void NNArea2DVisibilitySensor::set_squared_distances_to_intersecting_areas(TypedArray<float> squared_distances_to_intersecting_areas) {
...
void NNArea2DVisibilitySensor::set_squared_distances_to_intersecting_bodies(TypedArray<float> squared_distances_to_intersecting_bodies) {
...
TypedArray<float> NNArea2DVisibilitySensor::get_squared_distances_to_intersecting_areas() const {
	return _squared_distances_to_intersecting_areas;
}

TypedArray<float> NNArea2DVisibilitySensor::get_squared_distances_to_intersecting_bodies() const {
	return _squared_distances_to_intersecting_bodies;
}

void NNArea2DVisibilitySensor::set_squared_distances_to_unoccluded_areas(TypedArray<float> squared_distances_to_unoccluded_areas) {
...
void NNArea2DVisibilitySensor::set_squared_distances_to_unoccluded_bodies(TypedArray<float> squared_distances_to_unoccluded_bodies) {
...
TypedArray<float> NNArea2DVisibilitySensor::get_squared_distances_to_unoccluded_areas() const {
	return _squared_distances_to_unoccluded_areas;
}

TypedArray<float> NNArea2DVisibilitySensor::get_squared_distances_to_unoccluded_bodies() const {
