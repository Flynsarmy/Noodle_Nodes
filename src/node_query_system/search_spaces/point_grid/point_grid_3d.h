...
class NNPointGrid3DSearchSpace : public NNNQSSearchSpaces {
	GDCLASS(NNPointGrid3DSearchSpace, NNNQSSearchSpaces)

public:
	NNPointGrid3DSearchSpace();
	~NNPointGrid3DSearchSpace();
	...
	enum NNPointGrid3DSearchSpaceType {
		RECTANGLE = 0,
		CIRCLE = 1,
	};

	enum NNPointGrid3DSearchSpaceLatticeType {
		SQUARE = 0,
		TRIANGULAR = 1,
