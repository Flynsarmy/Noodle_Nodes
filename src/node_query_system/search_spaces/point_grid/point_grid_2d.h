#ifndef NNPointGrid2DSearchSpaces_H_INCLUDED
#define NNPointGrid2DSearchSpaces_H_INCLUDED
...
class NNPointGrid2DSearchSpace : public NNNQSSearchSpaces {
	GDCLASS(NNPointGrid2DSearchSpace, NNNQSSearchSpaces)

public:
	NNPointGrid2DSearchSpace();
	~NNPointGrid2DSearchSpace();
	...
	enum NNPointGrid2DSearchSpaceType {
		RECTANGLE = 0,
		CIRCLE = 1,
	};

	enum NNPointGrid2DSearchSpaceLatticeType {
		SQUARE = 0,
		TRIANGULAR = 1,
