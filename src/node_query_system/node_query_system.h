#ifndef NNNodeQuerySystem_H_INCLUDED
#define NNNodeQuerySystem_H_INCLUDED
...
class NNNodeQuerySystem : public NoodleNodes {
	GDCLASS(NNNodeQuerySystem, NoodleNodes)

private:
	godot::TypedArray<NNNQSSearchSpaces> _high_priority_queries;
	godot::TypedArray<NNNQSSearchSpaces> _regular_queries;
...
public:
	...
	int post_query(NNNQSSearchSpaces *search_space, bool is_high_priority = true);
	bool stop_query(NNNQSSearchSpaces *search_space);
	void run_queries();
	void clear_queries();
