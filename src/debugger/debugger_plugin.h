...
class NNDebuggerPlugin : public EditorDebuggerPlugin {
	GDCLASS(NNDebuggerPlugin, EditorDebuggerPlugin)
...
private:
	...
	static NNDebuggerPlugin *_singleton;
...
protected:
	...
	void btree_add_child_nodes(Tree *tree, TreeItem *parent_node, NNBTNodes *parent_ai_node);

public:
	NNDebuggerPlugin();
	~NNDebuggerPlugin();

	NNDebuggerPlugin *get_singleton() const { return _singleton; };
