...
if env["platform"] == "macos":
    library = env.SharedLibrary(
        "demo/addons/noodle_nodes/bin/libnoodlenodes.{}.{}.framework/libnoodlenodes.{}.{}".format(
    ...
    library = env.SharedLibrary(
        "demo/addons/noodle_nodes/bin/libnoodlenodes{}{}".format(env["suffix"], env["SHLIBSUFFIX"]),
        source=sources,
    )
